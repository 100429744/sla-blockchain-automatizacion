...
contract NetworkSLA {
    ...
    // --- NUEVO: ALMACENAMIENTO LIGERO PARA EL HASH DE IPFS ---
    mapping(uint256 => mapping(address => string)) public epochIpfsHash;
    ...
    function submitLatency(uint256 _epoch, uint256 _latencyMs, string calldata _ipfsHash) external inState(State.ACTIVE) onlyOracle {
        ...
        epochIpfsHash[_epoch][msg.sender] = _ipfsHash; 
